...
#-------------------------------------------------------------------------------
if (MacOSX)
	set(msg_dep_onepad      "check these libraries -> sdl2, gtk2")
else()
...
#---------------------------------------
# Common dependancy
if(wxWidgets_FOUND AND ZLIB_FOUND AND GTKn_FOUND AND common_libs AND NOT (Linux AND NOT AIO_FOUND))
    set(pcsx2_core TRUE)
...
#			-CG
#---------------------------------------
if(NOT MacOSX AND EXTRA_PLUGINS)
...
if(NOT MacOSX AND EXTRA_PLUGINS OR NOT PACKAGE_MODE)
...
#			-gtk2 (mac)
#---------------------------------------
if(wxWidgets_FOUND AND GTKn_FOUND AND SDL2_FOUND AND (NOT Linux OR X11_FOUND))
	set(onepad TRUE)
...
if(wxWidgets_FOUND AND GTKn_FOUND AND SDLn_FOUND AND (NOT Linux OR X11_FOUND))
